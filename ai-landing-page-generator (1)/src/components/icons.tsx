...
export const ClipboardDocumentCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.75m-8.5-4.364c-.055.194-.084.4-.084.612v3.75m-1.5-3.75a2.25 2.25 0 00-2.25 2.25v10.5c0 1.242 1.008 2.25 2.25 2.25h10.5c1.242 0 2.25-1.008 2.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25H10.5m-3.375 3.375a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25v1.5a2.25 2.25 0 01-2.25 2.25h-1.5a2.25 2.25 0 01-2.25-2.25v-1.5zm-3.375 9.75h10.5" />
